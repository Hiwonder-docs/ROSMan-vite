# ROSMan Documentation

This repository contains the ROSMan VitePress documentation site. The
...
The staged production files are generated in `projects/ROSMan/en/latest/`.
...
```text
https://hiwonder-docs.github.io/ROSMan-vite/projects/ROSMan/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/ROSMan/en/latest/
```
